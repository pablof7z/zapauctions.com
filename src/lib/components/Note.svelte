...
<div
    class="bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-lg p-6 w-full text-gray-700 dark:text-gray-100 flex flex-row max-h-96"
>
    <div class="flex flex-row overflow-scroll flex-1 gap-4">
        ...
        <div class="flex flex-col w-full overflow-scroll">
            ...
            <div class="text-xl overflow-scroll flex-1">
